        ...
        if num_mqa_tokens > 0:
            ...
            if self.is_aiter_triton_fp4_bmm_enabled:
                ...
                if self.q_pad_num_heads is not None:
                    ...
                    # Write the (N, B, L) bmm result straight into a token-major
                    # (B, N, L) buffer so the MQA query is already contiguous; a
                    # NoPE model (qk_rope_head_dim == 0) then needs no concat.
